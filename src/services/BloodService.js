...
const BLOOD_REG = "https://bloodbank-java.onrender.com/blood";
const BLOOD_SEARCH = "https://bloodbank-java.onrender.com/users/search";
...
class BloodService {
    ...
    static searchBlood(bloodGroup, bloodQuantity) {
        ...
        return axios
            .post(BLOOD_SEARCH, bloodDetails)
            .then((response) => {
                console.log(
                    "Blood search completed successfully:",
                    response.data
                );
