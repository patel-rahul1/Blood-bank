...
const DONOR_REG = "https://bloodbank-java.onrender.com/api/donors/register";
const DONOR_LOGIN = "https://bloodbank-java.onrender.com/api/donors/login";
const DONOR_UPDATE = "https://bloodbank-java.onrender.com/api/donors/";

const DONOR_DELETE = "https://bloodbank-java.onrender.com/api/donors/";

const APPOINTMENTS_GET_ALL =
    "https://bloodbank-java.onrender.com/api/appointments"; // URL for getting all appointments

const DONORS_GET_ALL = "https://bloodbank-java.onrender.com/api/donors"; // URL for getting all donors

class DonorService {
    static registerDonor(donor) {
        return axios
            .post(DONOR_REG, donor)
            .then((response) => {
    ...
    static updateDonor(id, updatedDonor) {
        return axios
            .put(DONOR_UPDATE + id, updatedDonor)
            .then((response) => {
